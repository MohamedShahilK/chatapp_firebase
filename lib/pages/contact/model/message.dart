...
// It is only used to add a new empty message whenever a new converstaion starts b/w 2 persons

// ie; Only for new conversion and it is used as first empty message
